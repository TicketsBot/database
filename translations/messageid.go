...
const (
	MessageNoPermission MessageId = iota // You do not have permission for this
	...
	*/
	...
	SetupReactionPanelsDescription // Visit the [dashboard](https://panel.ticketsbot.net/%d/panels) to create reaction panels
)
