...
func (p RolePermissions) Schema() string {
	return `
CREATE TABLE IF NOT EXISTS role_permissions("guild_id" int8 NOT NULL, "role_id" int8 NOT NULL, "support" bool NOT NULL, "admin" bool NOT NULL, PRIMARY KEY("role_id"));
CREATE INDEX CONCURRENTLY IF NOT EXISTS role_permissions_guild_id ON role_permissions("guild_id");
`
}
...
func (p *RolePermissions) RemoveAdmin(roleId uint64) (err error) {
	query := `UPDATE role_permissions SET "admin" = false WHERE "role_id" = $1;`
