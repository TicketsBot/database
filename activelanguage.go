...
func (c *ActiveLanguage) Get(guildId uint64) (language translations.Language, e error) {
...
func (c *ActiveLanguage) Set(guildId uint64, language translations.Language) (err error) {
